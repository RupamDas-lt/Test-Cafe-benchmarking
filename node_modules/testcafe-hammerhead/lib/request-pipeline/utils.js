...
async function handleRequestMockingErrorIfNecessary(ctx) {
    ...
    logger_1.default.proxy.onMockResponseError(targetRule, ctx.mock.error);
    await ctx.session.callRequestHookEventHandler(targetRule, ctx.mock.error);
}
exports.handleRequestMockingErrorIfNecessary = handleRequestMockingErrorIfNecessary;
