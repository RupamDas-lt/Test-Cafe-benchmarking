      ...
      return _regenerator["default"].wrap(function _callee$(_context) {
        while (1) switch (_context.prev = _context.next) {
          case 0:
            ...
            capabilities.build = 'testcafe_build_benchmarking_Jenkins';
            _context.next = 4;
            let startTime, endTime = 0;
            startTime = new Date();
            let driver = _wd["default"].promiseChainRemote("https://" + _util.PROCESS_ENVIRONMENT.LT_USERNAME + ":" + _util.PROCESS_ENVIRONMENT.LT_ACCESS_KEY + "@" + _util.AUTOMATION_HUB_URL + ":443/wd/hub", 443);
            endTime = new Date();
            const seconds = (endTime.getTime() - startTime.getTime()) / 1000;
            // console.log("Driver creation in seconds :- ", seconds);
            let startTimeString = "Test start time: "+String(startTime.getTime())+"\n";
    ...
    return (0, _asyncToGenerator2["default"])( /*#__PURE__*/_regenerator["default"].mark(function _callee3() {
      ...
      return _regenerator["default"].wrap(function _callee3$(_context3) {
        while (1) switch (_context3.prev = _context3.next) {
          ...
          case 16:
            _context3.next = 18;
            let startTime2, endTime2 = 0;
            startTime2 = new Date();
            let startBrowserReturnValue = _this3._startBrowser(id, pageUrl, capabilities);
            endTime2 = new Date();
            const seconds2 = (endTime2.getTime() - startTime2.getTime()) / 1000;
            return startBrowserReturnValue;
          case 18:
